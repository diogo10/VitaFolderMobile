...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFc2b299),
      surfaceTint: Color(0xFFc2b299),
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFFffffe9),
      onPrimaryContainer: Color(0xFF9a8a71),
      secondary: Color(0xFFC2B299),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFFffffe9),
      onSecondaryContainer: Color(0xFF9a8a71),
      tertiary: Color(0xFF539AD5),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFFa3eaff),
      onTertiaryContainer: Color(0xFF2b72ad),
      ...
      inversePrimary: Color(0xFFae9e85),
      primaryFixed: Color(0xFFffffe9),
      onPrimaryFixed: Color(0xFF86765d),
      primaryFixedDim: Color(0xFFfeeed5),
      onPrimaryFixedVariant: Color(0xFFae9e85),
      secondaryFixed: Color(0xFFffffe9),
      onSecondaryFixed: Color(0xFF86765d),
      secondaryFixedDim: Color(0xFFfeeed5),
      onSecondaryFixedVariant: Color(0xFFae9e85),
      tertiaryFixed: Color(0xFFa3eaff),
      onTertiaryFixed: Color(0xFF175e99),
      tertiaryFixedDim: Color(0xFF8fd6ff),
      onTertiaryFixedVariant: Color(0xFF3f86c1),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFae9e85),
      surfaceTint: Color(0xFFae9e85),
      onPrimary: Color(0xFF000000),
      primaryContainer: Color(0xFF86765d),
      onPrimaryContainer: Color(0xFF000000),
      secondary: Color(0xFFae9e85),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFF86765d),
      onSecondaryContainer: Color(0xFF000000),
      tertiary: Color(0xFF3f86c1),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF175e99),
      ...
      inversePrimary: Color(0xFFc2b299),
      primaryFixed: Color(0xFFffffe9),
      onPrimaryFixed: Color(0xFF86765d),
      primaryFixedDim: Color(0xFFfeeed5),
      onPrimaryFixedVariant: Color(0xFFae9e85),
